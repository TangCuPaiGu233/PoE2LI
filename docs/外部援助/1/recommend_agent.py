...
from . import entity_dict
from . import entity_data  # 全量传奇/升华真实数据（poe2db 爬虫产出）
# 接入时改成工程真实路径：
# from .embedding_service import embed_text
# from .knowledge_service import retrieve_similar
# from .ai_service import chat_completion
# from .pob_decoder import decode as decode_pob
