...
Usage:
    python scripts/pipeline/verify_data_completeness.py
    python scripts/pipeline/verify_data_completeness.py --data-dir ./backend/data/poe2_data
    python scripts/pipeline/verify_data_completeness.py --critical-only
"""
import argparse
import json
import os
